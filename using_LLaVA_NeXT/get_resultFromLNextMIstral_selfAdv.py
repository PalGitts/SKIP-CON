        ...
        for flag_imgDesc in shall_provide_image_description:
            ...
            for flag_useKShot in shall_use_exemplars:
                ...
                for flag_positiveStart in shall_use_positiveStart:
                    ...
                    file_name = f'./results/llavaNext1p6Mistral7B_selfAdv_noRC/noRC_withSelfAdvPromptIfRequired_{dataset_name}_NOI{num_of_imgs}_{img_type}_{img_desc}_{shall_useExemplars}_{shall_usePositiveStart}.json'
                    # file_name = f'./results/llavaNext1p6Mistral7B_selfAdv_withRC/withRC_withSelfAdvPromptIfRequired_{dataset_name}_NOI{num_of_imgs}_{img_type}_{img_desc}_{shall_useExemplars}_{shall_usePositiveStart}.json'
...
# CUDA_VISIBLE_DEVICES=1 python3 get_resultFromLNextMIstral_selfAdv.py --dataset_name beaverTails --rc NO --target attn_MLP --env EL 